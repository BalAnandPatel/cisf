<?php 
 ...
 class exam{
    ...
    public $id,$full_name,$registration_no,$dob,$mobile,$exam_name,$salary,$age,$total_post,$amount,$eligibility,$status,$exam_date_start,$exam_date_end,$result_date,$admit_card_date,$created_by,$created_on,$updated_on,$updated_by;
    ...
    public function read_exam(){
        $query="Select  id,exam_name,salary,age, amount,status,exam_date_start, result_date,admit_card_date,created_by,created_on
    ...
    public function read_exam_details(){
        $query="Select  id, exam_name, salary, age, total_post, eligibility, amount, status, exam_date_start, exam_date_end, result_date, admit_card_date, created_by, created_on
     ...
     public function read_payment_varify_details(){
       $query="Select  reg.id,reg.full_name,reg.registration_no,dob,mobile,reg.exam_name,amount,reg.status,
        ...
        where reg.registration_no=:registration_no and reg.mobile=:mobile and reg.status=0";
        $stmt = $this->conn->prepare($query); 
    ...
    public function read_exam_list(){
        $query="Select  id,exam_name,salary,age,total_post,eligibility,
